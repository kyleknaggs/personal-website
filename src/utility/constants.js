...
const TEXT = {
  ...
  ORDER_ENTRY_PROCESS_OLD_ALT: 'Diagram of the order entry process before the introduction of the web application',
  ORDER_ENTRY_PROCESS_OLD_DESCRIPTION: 'Diagram of the order entry process before the development of a web application:',
  ORDER_ENTRY_PROCESS_NEW_ALT: 'Diagram of the order entry process after the introduction of the web application',
  ORDER_ENTRY_PROCESS_NEW_DESCRIPTION: 'Diagram of the order entry process after the development of a web application:',
  FREEDOM_ORDER_ENTRY_ALT: 'Diagram of the of the software used by staff for order entry',
  ...
  WORKING_ORDER_ANALYSIS_ALT: 'Table containing the data that was recorded for all of the orders placed during a single day',
  WORKING_ORDER_ANALYSIS_DESCRIPTION: 'Analysis of a single day of orders:',
  PRECEDENT_SITE_STUDY_DIAGRAM_ALT: 'Diagram analyzing the layout of an Amazon product page',
  PRECEDENT_SITE_STUDY_DIAGRAM_DESCRIPTION: 'A sample of the analysis done when evaluating an existing user interface:',
  HOME_PAGE_MOCKUP_ALT: 'Mock up of the home page of the AFL Online web application',
